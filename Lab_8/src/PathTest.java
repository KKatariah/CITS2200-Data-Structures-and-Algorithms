...
public class PathTest {
     ...
     * maxweight is an integer representing the maximum possible edge weight. The
     * random
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 3 && args[0].equals("F")) {
            ...
            g = Graph.randomWeightedGraph(Integer.parseInt(args[1]), false, Double.parseDouble(args[2]),
