 ...
 public class SortTest
 {
    ...
    public static void runMain(int size)
    {
     ...
     System.out.println("Insertion sort used "+s.getCount()+" assignments to sort "+size+ " longs");
     ...
     System.out.println("Merge sort used "+s.getCount()+" assignments to sort "+size+ " longs");
